...
print("&nbsp; &nbsp;  &nbsp;Welkom ".$_SESSION[naam]." ".$_SESSION[vnaam]." &nbsp; &nbsp; &nbsp; &nbsp; ");
...
elseif(($_SESSION[school_id]=="0") and ($_SESSION[aard]=="school"))
{
	...
	$q_schoolaccess=
    "select t1.*,t2.abonnement 
    from agora_campus as t1 
    inner join agora_scholen as t2 on t2.id=t1.school_id 
    where t1.id_pa='".$_SESSION['user_id']."' and t1.aard='Hoofdcampus'
    ";
...
left join agora_rechten as t4 on t4.id_school=t1.id
	...
	else
	{
		...
		include_once("beheer/meldingen.php");
	}
}
else
{
