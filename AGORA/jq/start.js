...
function nieuweFout(agora)
{
	...
	var dialogOpts = {
        ...
        buttons:
		{
			"Opslaan":function() 
			{
				$.post("http://agora.weveco.net/jq/process/bug.php", $("#bugNieuw").serialize(),  function(data)
				{ 
					switch(data)
				 	{
						case '0':
		...
		open:function() 
		{
			$.post("http://agora.weveco.net/jq/process/bug.php",{actie:'nieuw',agora:agora}, function(data) 
				{
					$("#bug").html(data);
				});
		}		
...
function toonBug(id)
{
		...
		open:function() 
		{
			$.post("http://agora.weveco.net/jq/process/bug.php",{actie:'detail',id:id}, function(data) 
				{
					$("#bug").html(data);
				});
		}		
...
function bugOpgelost(id)
{
	var dialogOpts = {
		...
		open:function() 
		{
			$.post("http://agora.weveco.net/jq/process/bug.php",{actie:'form',id:id}, function(data) 
				{
					$("#oplossing").html(data);
				});
		},
		buttons:
		{
			"Opslaan":function() 
			{
				$.post("http://agora.weveco.net/jq/process/bug.php", $("#feedback").serialize(),  function(data)
				{ 
					switch(data)
				 	{					
						case '0':
...
function leesNieuws(id)
{
	var dialogOpts = {
        ...
        //$(this).parent().children().children('.ui-dialog-titlebar-close').hide(); 
	        $.post("http://agora.weveco.net/jq/process/leesNieuws.php",{id:id},function(data)
				{
...
function locatieInfo(id)
{
	var dialogOpts = {
		...
		open:function() 
		{
			$("#info").html("<center>De gegevens worden opgezocht in de databank.<br /><br /><img src='http://agora.weveco.net/images/progress.gif'></center>");
			
			$.post("http://agora.weveco.net/jq/process/locatie_informatie.php",{id:id}, function(data) 
				{
					switch(data)
				 	{
						case '0':
...
{
	$.post("http://agora.weveco.net/jq/process/dashboard_weveco.php",{}, function(data) 
	{
	 	$("#db_weveco").html(data);
	});
}
...
{
	$.post("http://agora.weveco.net/jq/process/dashboard_taakbeheer.php",{}, function(data) 
	{
	 	$("#db_agenda").html(data);
	});
}
...
function vskoCpaUpdate()
{
	...
	$.post("http://agora.weveco.net/jq/process/cpabeheer.php",$("#vskoCPA").serialize(), function(data) 
	{
	 	feedback(data);
	});
}
...
function vsko_selecteer_scholen()
{
	var dialogOpts = {
		...
		open:function() 
		{
			$("#vsko").html("<center><br /><br /><h2><font color=red>De gegevens worden opgezocht in de databank.<br /><br />Dit kan enkele minuten duren!</h2></font><br /><br /><img src='http://agora.weveco.net/images/progress.gif'></center>");
...
function vsko_school_voegtoe(schoolbestuur,instellingsnr)
{
	var dialogOpts = {
		...
		open:function() 
		{
			$("#vsko_school").html("<center>De gegevens worden opgezocht in de databank.<br /><br /><img src='http://agora.weveco.net/images/progress.gif'></center>");
...
function vsko_form_zoek_instellingsnr(aard)
{
	var dialogOpts = {
		...
		open:function() 
		{
			$("#vsko_zoek").html("<center>De gegevens worden opgezocht in de databank.<br /><br /><img src='http://agora.weveco.net/images/progress.gif'></center>");
...
{
	feedback("Update databank gestart!<br /><img src='../images/progress.gif'>");
